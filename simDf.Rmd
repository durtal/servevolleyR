...
When converting an object returned by `simGames`, `simSets` and `simMatches`, I'd recommend adding `plyr`'s progress bar, `.progress = "text"`, to `simDf` as large number of simulations will take a while to convert to a dataset.
